...
import { FichierCommercialeComponent } from "../fichier-commerciale/fichier-commerciale.component";

@Component({
  selector: 'app-commerciale',
  templateUrl: './commerciale.component.html',
  standalone: true, // Mode standalone
  imports: [ReactiveFormsModule, CommonModule, StepperComponent, FichierPermisComponent,
    CdkStepperModule,
    NgTemplateOutlet,
    DemandeurComponent,
    FichierComponent,
    RouterModule, PersonneMoraleComponent, FichierCommercialeComponent]
   // Ajout des imports nécessaires
})
export class CommercialeComponent {
